...
TEST_F(UnnestTest, basicArray) {
  ...
  // The first array consists of 200 elements going from 199, 198.... (because
  // of the dictionary with reverse indices) and NULL for every 13th element.
  // The second array is a constant vector of size 100.
  // The Unnest should produce a ROW of 2 vectors with 200 elements each.
  // The first vector contains integers from 199...0 and NULL for every 13th
  // row. The second vector has 100 entries with "abcd" followed by 100 rows
  // with NULL.
